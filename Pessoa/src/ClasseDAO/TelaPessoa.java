...
public class TelaPessoa extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try {
            ...
            d1.setNomeCliente(jTextField1.getText());
            d1.setEndereco(jTextField2.getText());
            d1.setTelefone(jTextField3.getText());
            d1.setUf(jTextField4.getText());
            d1.setDocumento(jTextField5.getText());
            d1.setEmail(jTextField6.getText());
            
            
            con.salvar(d1);
            JOptionPane.showMessageDialog(null, "Operação Concluida com Sucesso", "Inclusão", JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception e) {
